...
const AboutSection: React.FC = () => {
  return (
    <div className="about-section">
      ...
      <Card>
        <p>
          Launched in Autumn 2020, Real Pizza Company is the newest addition to
          the MLG family.
        </p>
        <p>
          During tricky times, we have made it our aim to be able to provide our
          hardworking local businesses, within North West London, with our
